...
public class OdontologoDaoH2 implements IDao<Odontologo> {
    ...
    private static String SQL_UPDATE = "UPDATE ODONTOLOGOS SET APELLIDO=?, NOMBRE=?, NUMEROMATRICULA =? WHERE ID=?";
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                String numeroMatricula = resultSet.getString(4);
                 ...
                 odontologoEncontrado= new Odontologo(idDevuelto, apellido, nombre,numeroMatricula);
            }
